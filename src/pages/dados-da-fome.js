...
const DadosDaFome = () => {
  return (
    <>
      ...
      />
      <Image src='/images/mapa-fome.png' alt='Mapa da fome' height={'1500px'} />
      <Image src='/images/fome-mundo.png' alt='Mapa da fome' />
      <Image src='/images/fome-brasil.png' alt='Mapa da fome' />
